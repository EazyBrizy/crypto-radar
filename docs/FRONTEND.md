...
- Active historical progress should surface backend `runtime_state` progress fields such as `bars_processed`, `bars_total`, `bars_pct`, `scenario_bars_processed`, `scenario_bars_total`, `bars_per_second`, `eta_seconds`, `pending_armed`, `pending_entries_count`, `no_entry`, and `filled` when present.
