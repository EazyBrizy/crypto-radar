...
const typedDictionary = {
  en: {
    ...
    signalDetails: {
      ...
      edgeLearningWarning: "Learning mode: edge is not calibrated yet. Virtual pending is allowed; real execution still requires positive edge.",
    ...
    pendingEntry: {
      ...
      collapseQueue: "Collapse pending entries queue",
      expandQueue: "Expand pending entries queue",
      hiddenCount: "{count} hidden",
      activePendingEntry: "Active pending entry",
      pendingEntry: "Pending entry",
      detailsTitle: "Pending entry details",
      acceptedSnapshot: "Accepted snapshot",
      originalSignalMissing: "Original signal is not in the current feed. Cancel remains available.",
      ...
      openQueueItem: "Open pending entry {symbol} ({id})",
      hideQueueItem: "Hide pending entry {id}",
      hide: "Hide",
      reconfirm: "Reconfirm",
    ...
    execution: {
      ...
      realExecutionPreview: "Real execution preview",
    ...
    reasonCodes: {
      ...
      edge_insufficient_sample: "Edge has insufficient sample size",
  ...
  ru: {
    ...
    radar: {
      ...
      hotFilter: "Горячие входы",
      diagnosticsFilter: "Диагностика",
    ...
    pendingEntry: {
      ...
      collapseQueue: "Свернуть очередь ожидающих входов",
      expandQueue: "Развернуть очередь ожидающих входов",
      hiddenCount: "{count} скрыто",
      activePendingEntry: "Активный ожидающий вход",
      pendingEntry: "Ожидающий вход",
      detailsTitle: "Детали ожидающего входа",
      acceptedSnapshot: "Принятый снимок",
      originalSignalMissing: "Исходного сигнала нет в текущей ленте. Отмена все еще доступна.",
      ...
      openQueueItem: "Открыть ожидающий вход {symbol} ({id})",
      hideQueueItem: "Скрыть ожидающий вход {id}",
      hide: "Скрыть",
    ...
    reasonCodes: {
      ...
      edge_insufficient_sample: "Недостаточный размер выборки для edge",
