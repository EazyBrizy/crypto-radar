...
class MarketDerivativeSnapshot(Base):
    ...
    open_interest_value: Mapped[Decimal | None] = mapped_column(Numeric(38, 18), nullable=True)
    oi_change: Mapped[Decimal | None] = mapped_column(Numeric(18, 10), nullable=True)
