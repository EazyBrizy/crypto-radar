...
const typedDictionary = {
  en: {
    ...
    radar: {
      ...
      allIdeasFilter: "Working feed",
      watchlistFilter: "Watchlist",
      readyToExecuteFilter: "Ready to execute",
      blockedFilter: "Blocked diagnostics",
      blockedDiagnosticsWarning: "These are diagnostic ideas, they are not entry signals.",
      allFilter: "all",
      longFilter: "long",
      shortFilter: "short",
    ...
    signalDetails: {
      ...
      waitingEntryUnavailable: "Waiting entry unavailable: {reason}",
      actionUnavailable: "Unavailable: {reason}",
    ...
    reasonCodes: {
      ...
      edge_unknown: "Execution edge is unknown",
      edge_missing: "Execution edge data is missing",
      trade_plan_incomplete: "Trade plan is incomplete",
      no_trade_hard_block: "No-trade filter blocks execution",
      virtual_execution_blocked: "Virtual execution is blocked",
      rr_failed: "Risk/reward guard failed",
      decision_not_actionable: "Backend decision is not actionable",
      terminal_signal: "Signal is terminal",
      execution_gate_blocked: "Execution gate blocks this action",
      strategy_eligibility_failed: "Strategy eligibility failed",
      strategy_eligibility_missing: "Strategy eligibility is missing",
      strategy_regime_incompatible: "Strategy regime incompatible",
      strategy_regime_post_impulse_retest: "Post-impulse breakout requires retest",
      strategy_regime_watchlist: "Strategy regime watchlist",
      ...
      expired_before_touch: "Pending entry expired before entry touch",
      cancelled: "Cancelled",
  ...
  ru: {
    ...
    radar: {
      ...
      allIdeasFilter: "Рабочая лента",
      watchlistFilter: "Watchlist",
      readyToExecuteFilter: "Готово к исполнению",
      blockedFilter: "Диагностика блокировок",
      blockedDiagnosticsWarning: "Это диагностические идеи, они не являются сигналами для входа.",
      allFilter: "все",
      longFilter: "long",
      shortFilter: "short",
    ...
    signalDetails: {
      ...
      virtualWaitEntry: "Virtual wait entry",
      realWaitEntry: "Real wait entry",
      waitingEntryUnavailable: "Ожидание входа недоступно: {reason}",
      actionUnavailable: "Недоступно: {reason}",
      virtualEntryNow: "Virtual entry now",
      virtualEntryLocked: "Virtual entry locked",
    ...
    reasonCodes: {
      ...
      edge_unknown: "Execution edge неизвестен",
      edge_missing: "Данные execution edge отсутствуют",
      trade_plan_incomplete: "План сделки неполный",
      no_trade_hard_block: "No-trade фильтр блокирует исполнение",
      virtual_execution_blocked: "Виртуальное исполнение заблокировано",
      rr_failed: "Risk/reward guard не пройден",
      decision_not_actionable: "Backend-решение не является исполнимым",
      terminal_signal: "Сигнал terminal",
      execution_gate_blocked: "Execution gate блокирует это действие",
      ...
      expired_before_touch: "Ожидающий вход истек до касания зоны входа",
      cancelled: "Отменено",
      execution_failed: "Виртуальное исполнение завершилось ошибкой",
