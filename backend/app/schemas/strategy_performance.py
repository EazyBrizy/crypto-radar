...
class StrategyPerformanceDaily(BaseModel):
    ...
    pending_armed_count: int = Field(default=0, ge=0)
    filled_count: int = Field(default=0, ge=0)
    no_entry_count: int = Field(default=0, ge=0)
    execution_rejected_count: int = Field(default=0, ge=0)
    entry_touch_rate: float = Field(ge=0)
    fill_rate: float = Field(default=0.0, ge=0)
    no_entry_rate: float = Field(default=0.0, ge=0)
    execution_rejected_rate: float = Field(default=0.0, ge=0)
