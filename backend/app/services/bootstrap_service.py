    ...
    for spec in SEED_STRATEGY_VERSIONS:
        ...
        config_schema = {
            ...
            "properties": {
                ...
                "require_reclaim": {"type": "boolean"},
                "require_absorption": {"type": "boolean"},
                "min_absorption_score": {"type": "number", "minimum": 0, "maximum": 1},
                "min_cvd_divergence_score": {"type": "number", "minimum": 0, "maximum": 1},
                "min_oi_flush_score": {"type": "number", "minimum": 0, "maximum": 1},
                "min_obvious_liquidity_score": {"type": "number", "minimum": 0, "maximum": 1},
                "min_target_distance_r": {"type": "number", "minimum": 0},
                "alpha_context_required": {"type": "boolean"},
                "require_oi_flush": {"type": "boolean"},
                "liquidation_flush_bonus": {"type": "number", "minimum": 0},
            },
    ...
    values = {
        ...
        "settings": {
            ...
            "risk_management": {
                ...
                "real_requires_positive_edge": True,
                "real_fee_rate_ttl_seconds": 86400,
                "edge_min_sample_size": 50,
