...
class RiskManagementSettings(BaseModel):
    ...
    max_symbol_risk_percent: float = Field(default=3.0, ge=0, le=100)
    max_strategy_exposure_percent: float = Field(default=3.0, ge=0, le=100)
...
class RiskManagementPatch(BaseModel):
    ...
    max_symbol_risk_percent: float | None = Field(default=None, ge=0, le=100)
    max_strategy_exposure_percent: float | None = Field(default=None, ge=0, le=100)
